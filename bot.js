...
`,true)
    ...
    member.addRole("818149352001896491")
    
    const arrow = client.emojis.get (`722640275993788523`) 
    ...
    .setDescription(`<@${member.user.id}>**, Aramıza Hoşgeldin.**
     ...
     ${arrow} **Teyit Olabilmeniz İçin Odalarından Birine Geçiniz.**
...
`,true)
    ...
    .setTimestamp()
    .setImage("https://cdn.discordapp.com/attachments/522576410083328010/825172471703142410/01b737a603119cb9f5a91e5c48e22203c47838a7r1-500-311_hq.gif")
...
client.on("userUpdate", async (old, nev) => {
  ...
  let emingRol = "818149327566405632"; //ROL ID
  let emingTag = "⊀"; //TAG
  if (old.username !== nev.username) {
    ...
    if (
      ...
      client.channels
        .get(emingKanal)
        .send(
          ` **${nev}, \`${emingTag}\` Tagını çıkarttı \`⊀ Family of the Revers\` rolünü kaybetti.**`
        );
    }
  }
});
...
client.on('ready', () => {
  client.channels.get('818149407941591041').join()
})
